<?php
/**
 * Match en direct (GET /live/{server}).
 * Variables attendues : $server, $entry, $mapDisplay, $redPlayers, $bluePlayers,
 *                       $redScore, $blueScore, $playerCount, $startedAt.
 */
...
function liveRowHtml(array $p, int $rank): string
{
    ...
    $iconExists = $classKey !== '' && is_file(APP_ROOT . '/_img/classes/' . $classKey . '.png');
