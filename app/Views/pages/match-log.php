...
/**
 * Détail d'un match.
 * Variables attendues : $logId, $mapDisplay, $gameMode, $gameModeLabel, $matchDate,
 *                       $durationDisplay, $playerCount, $hasTeamData, $redScore, $blueScore,
 *                       $teamPanels, $otherPlayers, $isAdmin.
 */
...
function matchRowHtml(array $p, int $rank): string
{
    ...
    $iconExists = is_file(APP_ROOT . '/_img/classes/' . $classPlayed . '.png');
