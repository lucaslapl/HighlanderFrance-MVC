<?php
/**
 * Édition d'un compte joueur (admin).
 * Variables : $target (steamid64, steamid3, player, final_name, current_country).
 */
?>
            ...
            <div class="form-grid-2">
                ...
                <div class="form-group">
                    ...
                    <select name="country" id="country" class="form-control">
                        ...
                        <?php if (!array_key_exists($target['current_country'], COUNTRIES) && !empty($target['player']['country'])): ?>
        ...
        <div class="form-section">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                <label class="admin-label" style="justify-content: space-between; width: 100%; box-sizing: border-box;">
                    ...
                    <div>
                        <?php if ((int)$target['player']['name_changed'] === 1): ?>
                ...
                <label class="admin-label" style="justify-content: space-between; width: 100%; box-sizing: border-box;">
                    ...
                    <div>
                        <?php if (isset($target['player']['country_locked']) && (int)$target['player']['country_locked'] === 1): ?>
                            <span class="badge-status" style="background: #d9534f; color: #fff;">Déjà utilisé</span>
                        <?php else: ?>
                            <span class="badge-status" style="background: #5cb85c; color: #fff;">Libre</span>
                        <?php endif; ?>
