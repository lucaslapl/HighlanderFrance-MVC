...
/**
 * Dashboard admin.
 * Variables : $dashboard, $apiStatuses, $techTeam.
 */
?>
...
<div class="admin-content-layout">
    ...
    <aside class="admin-sidebar">
        ...
        <?php if (empty($dashboard['recentUsers'])): ?>
        ...
        <div class="admin-card admin-card--alt">
            ...
            <?php else: ?>
                <div class="admin-sidebar__stack">
                    ...
                    <?php foreach ($techTeam as $admin): ?>
                        <?php $steamid64Link = \App\Services\SteamId::toSteamId64($admin['steamid']); ?>
