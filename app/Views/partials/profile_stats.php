<?php
/**
 * Onglets de mode + statistiques + matchs récents d'un profil.
 * Variables attendues : $stats, $steamid64, $isOwnDashboard.
 */
?>
...
<div class="player-stats">
    ...
    <div class="stats-grid stats-lists">
        <div class="box-stats classes-played">
            ...
            <div id="classes-container">
                <?php if (empty($stats['classes_played'])): ?>
                    <p class="no-data">Aucune donnée de classe pour le moment.</p>
                <?php else: ?>
                    <ul class="stats-list">
                        <?php foreach ($stats['classes_played'] as $class): ?>
        ...
        <div class="box-stats classes-killed">
            ...
            <div id="classes-killed-container">
                <?php if (empty($stats['classes_killed'])): ?>
    ...
    <div class="recent-matches">
        ...
        <div id="recent-container">
            <?php if (empty($stats['recent_matches'])): ?>
            ...
            <?php else: ?>
                <table class="matches-table">
                    ...
                    <tbody>
                        <?php foreach ($stats['recent_matches'] as $match): ?>
                            <?php
