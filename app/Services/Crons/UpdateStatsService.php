...
/**
 * Mise à jour des stats de match pour les joueurs (update_stats.php).
 */
final class UpdateStatsService
{
    ...
    private const HISTORY_FILE = DATA_DIR . '/log_update_stats.txt';
    ...
    public function run(): string
    {
        ...
        $repo = new MatchStatsRepository($this->db);
